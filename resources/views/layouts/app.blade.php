                ...
                <aside class="w-full md:w-[250pt] p-4">
                    <div class="bg-gray-800  rounded-xl p-4 px-6 text-gray-200 py-5">
                        ...
                        <div class="my-5 nav-content transition hidden md:block">
                            ...
                            <a href="/transactions" class="w-full py-3 flex space-x-3 cursor-pointer items-center hover:bg-[#0003] hover:text-gray-50 hover:px-3 rounded-lg transition-all">
                                <div class="">
