...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Transport Project') }}</title>
        ...
        <script>
            function confirmReq (id) {
                const proceed = confirm("Are you sure you want to approve this request?")
                if(proceed){
                    $.get(`/api/admin/bookings/confirm/${id}`, res => {
                        console.log(res)
                        alert(res.message)
                        fetchData()
                    })
            ...
            function cancelReq (id) {
                const proceed = confirm("Are you sure you want to delete this request?")
                if(proceed){
                    $.get(`/api/admin/bookings/cancel/${id}`, res => {
                        console.log(res)
                        alert(res.message)
                        fetchData()
                    })
